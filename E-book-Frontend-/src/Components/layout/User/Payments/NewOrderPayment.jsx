            ...
            <CardContent className="p-4">
              ...
              <AnimatePresence>
                {isExpanded && (
                  ...
                  >
                    {(coupons.filter(coupon => calculateTotal() >= coupon.minimumAmount).length > 0) ? (
                      coupons
                        .filter(coupon => calculateTotal() >= coupon.minimumAmount)
                        .map((coupon) => (
                          <motion.div
                            key={coupon._id}
                      ...
                      <div className="text-center text-gray-500 text-sm py-4">
                        No coupons available for your cart amount.
                      </div>
                    )}
                  </motion.div>
                )}
